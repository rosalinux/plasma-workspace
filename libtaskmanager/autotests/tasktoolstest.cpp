...
void TaskToolsTest::initTestCase()
{
    ...
    QFile::copy(QFINDTESTDATA("data/applications/firefox.desktop"), dataDir + QLatin1String("/applications/firefox.desktop"));
    ...
    QVERIFY(KService::serviceByDesktopName(QStringLiteral("firefox")));
}
...
void TaskToolsTest::testWindowUrlFromMetadata_data()
{
    ...
    QTest::addRow("Firefox") << QStringLiteral("Firefox") << QStringLiteral("Navigator") << QUrl(QStringLiteral("applications:firefox.desktop"));
